...
const config: CapacitorConfig = {
  ...
  android: {
    ...
    // Inspección del WebView (chrome://inspect) SOLO en el APK de prueba; release: nunca.
    webContentsDebuggingEnabled: process.env.GM_DEV_HTTP === "1",
  },
  server: {
    androidScheme: "https",
