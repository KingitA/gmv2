...
import { RecepcionDashboard } from "@/components/deposito-recepcion/recepcion-dashboard"
        ...
        return (
            <div className="flex min-h-screen items-center justify-center p-6">
                <div className="text-center">
                    ...
                    <Link href="/deposito">
                        <Button variant="outline">Volver a Depósito</Button>
                    </Link>
                </div>
            </div>
        )
    ...
    return (
        <div className="flex min-h-screen flex-col bg-muted/30">
                ...
                <div className="container mx-auto flex h-16 items-center justify-between px-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Órdenes de Compra y Recepciones - {profile.nombre || profile.email}</p>
                        </div>
                    </div>
            ...
            <main className="flex-1 container mx-auto p-4 max-w-6xl">
                <RecepcionDashboard userId={user.id} />
            </main>
        </div>
    )
}
